...
return [
    ...
    'search' => [
        ...
        'watch' => 'Avísame de novedades',
        'watch_hint' => 'Miramos una vez al día y te avisamos cuando algo nuevo coincide con esta búsqueda.',
        'watch_price_label' => 'Solo por debajo de (opcional)',
        'watch_confirm' => 'Seguir esta búsqueda',
        'watching' => 'Sigues esta búsqueda',
        'watching_under' => 'Sigues esta búsqueda, por debajo de :price',
        'stop_watching' => 'Parar',
        'watch_sign_in' => 'Inicia sesión para seguir una búsqueda',
        'watch_created' => 'Te avisaremos de las novedades de esta búsqueda.',
        'watch_removed' => 'Ya no sigues esta búsqueda.',
        'watch_needs_term' => 'Escribe algo primero para seguirlo.',
    ...
    'lists' => [
        ...
        'empty_for_someone_step3' => 'Quien compra algo lo reserva, para que nadie compre lo mismo.',
        ...
        'remove_confirm' => '¿Quitar :title de esta lista?',
        ...
        'from_your_friends' => 'De tus amigos',
        ...
        'role_editor' => 'Puede añadir artículos',
        'adding_allowed' => 'Se puede añadir',
        'share_email' => 'Correo',
        ...
        'shared_intro_gift' => 'Esta lista de regalos se comparte con varias personas. Marca lo que llevas tú para que nadie repita.',
        ...
        'about_for_someone_private' => 'Una lista sobre esa persona, y solo la ves tú. Compártela si vais a comprar varias personas.',
        'about_for_someone_shared' => 'Cada persona compra algo distinto. Reserva uno para que nadie repita.',
        ...
        'new_mine_body' => 'Cosas que te gustaría tener. Guárdala para ti, o compártela y que cada persona reserve lo que lleva.',
        'new_for_someone_body' => 'Una lista sobre esa persona. Guárdala para ti, o compártela: entonces la construís entre varias personas y os repartís la compra.',
    ...
    'recipients' => [
        ...
        'claim_is_you' => 'Este es el enlace que les envías. Tú creaste esta lista, así que no puede ser tuya: es esa persona quien dice "soy yo".',
    ...
    'santa' => [
        ...
        'seo_description' => 'Crea un grupo, sortea los nombres online y cada persona solo ve a quién le toca. Sin sombrero, sin hoja de cálculo, sin filtraciones.',
        ...
        'budget' => 'Presupuesto',
        'budget_hint' => 'Más o menos lo que debería gastar cada persona.',
        ...
        'draw_confirm' => '¿Hacer el sorteo para :count personas? Todos recibirán un correo con un nombre, y eso no se puede deshacer.',
        'draw_needs_two' => 'El sorteo necesita al menos dos personas.',
        'members_count' => ':count personas',
    ...
    'quiz' => [
        ...
        'submit' => 'Ver tu resultado',
        'answered_of' => ':answered de :total respondidas',
        ...
        'play_again' => 'Ya has jugado. Una vez por persona, si no la puntuación no significa nada.',
    ...
    'gift_cove' => [
        ...
        'seo_description' => 'Listas de deseos, listas para otros, comprar entre varios, Amigo invisible, alertas de precio e ideas de regalo. Nadie ve quién ha comprado qué.',
        ...
        'intro' => 'Todo para regalar a los demás, y para contar lo que te gustaría a ti.',
        'tools' => 'Lo que puedes hacer aquí',
        'band_together' => 'Con otras personas',
        'band_find' => 'Encontrar un regalo',
        'band_inspire' => 'Inspirarse',
        'search_title' => 'Buscar y comparar',
        'search_body' => 'Encuentra un producto en las tiendas de tu país y mira quién lo vende más barato. En el móvil, escanea el código de barras.',
        'ask_title' => 'Pregunta a otros',
        'ask_body' => 'Describe para quién buscas y deja que la comunidad sugiera algo. Cada respuesta llega con productos reales y un precio.',
        'alerts_title' => 'Notificaciones',
        'alerts_body' => 'Alguien comparte una lista contigo, sugiere algo, alguien de tu lista de amigos está a punto de cumplir años, baja un precio: te enteras aquí y por correo.',
        'friends_title' => 'Amigos',
        'friends_body' => 'Las personas con las que compartes listas, con su cumpleaños, para que un recordatorio llegue dos semanas antes del día.',
        'daily_title' => 'La Cove del día',
        'daily_body' => 'Una pequeña selección elegida a mano, nueva cada mañana. Para cuando no buscas nada en concreto.',
        'guides_title' => 'Guías de compra',
        'guides_body' => 'Lo que importa al elegir, por tema, con los productos que encajan. Para leer antes de comprar, no después.',
        'ideas_title' => 'Ideas de regalo',
        'ideas_body' => 'Ideas por persona, ocasión y presupuesto, cada una lista para guardarse directamente en una lista.',
        'surprise_title' => 'Cove Sorpresa',
        'surprise_body' => 'Algo raro en vez de algo popular, para quien ya lo tiene todo.',
        ...
        'manual' => 'Cómo funciona cada herramienta',
        'manual_link' => 'Cómo funciona cada herramienta',
        ...
        'wishlist_title' => 'Comparte tu propia lista de deseos',
        'wishlist_body' => 'Guarda lo que te gustaría y comparte el enlace. Quien lo abre reserva lo que lleva, y así nada se compra dos veces. Tú nunca ves nada de eso.',
        ...
        'giftlist_cta' => 'Empezar una lista para alguien',
        'split_title' => 'Comprar por separado para una persona',
        'split_body' => 'Comparte una lista sobre alguien con las demás personas que regalan. Quien compra algo lo reserva, y nadie compra dos veces lo mismo.',
        'split_cta' => 'Empezar a coordinar',
        'handover_cta' => 'Entregar una lista',
        'build_title' => 'Construir una lista entre varios',
        'build_body' => 'Activa "cualquiera puede añadir" y cualquiera con el enlace pone cosas. Solo añadir: nadie más que tú quita nada.',
        'build_cta' => 'Abrir una lista para compartir',
        'collab_cta' => 'Empezar un regalo en grupo',
        'board_title' => 'Charlar sobre una lista',
        'board_body' => 'Cada lista compartida tiene un tablón al lado, solo para quienes regalan. La persona para quien es la lista nunca lo ve.',
        'board_cta' => 'Abrir una lista compartida',
        'santa_cta' => 'Crear un grupo',
        'quiz_cta' => 'Crear un quiz',
        'friends_cta' => 'Ver mis amigos',
        'whisperer_cta' => 'Describir a alguien',
        'search_cta' => 'Buscar',
        'ask_cta' => 'Preguntar',
        'alerts_cta' => 'Ver mis notificaciones',
        'daily_cta' => 'Ver hoy',
        'guides_cta' => 'Leer las guías',
        'ideas_cta' => 'Explorar ideas',
        'surprise_cta' => 'Sorpréndeme',
    ],
    ...
    'wizard' => [
        ...
        'step_sharing' => 'Compartir',
        'step_done' => 'Listo',
        'kind_hint' => 'Esto decide qué puede hacer la lista. Todo lo demás se cambia después; esto no.',
        'kind_mine_body' => 'Cosas que te gustaría tener. Guárdala para ti, o compártela: entonces la gente reserva lo que lleva, y así nada se compra dos veces. Tú nunca ves qué, ni quién.',
        'kind_for_someone_body' => 'Una lista sobre otra persona. Guárdala para ti como notas, o compártela: entonces la construís entre varias personas y os repartís la compra, para que nadie compre lo mismo.',
        'kind_group_body' => 'Varias personas comprando un solo regalo. Todo el mundo vota, pone su parte, y una persona lo compra.',
        'title_placeholder_mine' => 'Mi cumpleaños, Cosas que me gustarían…',
        'title_placeholder_for_someone' => 'Ideas para papá, Ana cumple 30…',
        'title_placeholder_group' => 'Un regalo para Sam de parte de todos…',
        'person' => '¿Para quién es?',
        'person_hint' => 'Elige a uno de tus amigos para vincular la lista a su cuenta, o escribe un nombre para alguien que no está aquí.',
        'occasion' => '¿Una ocasión? (opcional)',
        'occasion_hint_mine' => 'Una lista de deseos con fecha es una lista de regalos: la gente ve para qué es y cuándo. Después puedes añadir una dirección de envío en la lista, visible solo para quien reserve algo. Te lo recordamos dos semanas antes.',
        'occasion_hint_other' => 'Di para qué es y cuándo, y te lo recordamos dos semanas antes, cinco días antes y el mismo día.',
        'date_label' => 'Fecha',
        'date_known' => 'Cae el :date.',
        'date_other' => 'Otra fecha',
        'date_from_birthday' => 'Ponemos ese cumpleaños como fecha en la lista.',
        'date_needs_birthday' => 'Escribe arriba su cumpleaños y la fecha viene sola.',
        'date_needs_mine' => 'No sabemos tu cumpleaños, así que elige aquí la fecha. Puedes añadirlo en la página de amigos.',
        'sharing' => '¿Quién puede verla?',
        'sharing_hint_mine' => 'Privada significa solo tú. Compartida significa que cualquiera con el enlace puede abrirla y reservar lo que lleva, y así nada se compra dos veces.',
        'sharing_hint_for_someone' => 'Privada significa solo tú: tus propias notas sobre esa persona. Compártela y los demás reservan, añaden ideas y charlan en el tablón.',
        'sharing_hint_group' => 'Un regalo en grupo necesita a los demás: compártela y envíales el enlace. Votan, ponen su parte y charlan en el tablón.',
        'visibility_private' => 'Privada',
        'visibility_link' => 'Compartir con un enlace',
        'visibility_private_mine' => 'Solo tú la ves. Puedes compartirla en cualquier momento.',
        'visibility_link_mine' => 'Cualquiera con el enlace la ve y reserva lo que lleva, y así nada se compra dos veces. Nada de eso te llega nunca.',
        'visibility_private_for_someone' => 'Solo tú la ves. Útil para reunir ideas sin que se note.',
        'visibility_link_for_someone' => 'Las demás personas la ven, reservan lo que llevan, y la persona para quien es no se entera de nada.',
        'visibility_private_group' => 'Solo tú, por ahora. Puedes compartirla en cuanto tenga algo.',
        'visibility_link_group' => 'Cualquiera con el enlace vota, aporta y charla. La persona para quien es nunca la ve.',
        'can_add_hint' => 'Construid la lista entre varias personas: cualquiera con el enlace puede poner cosas. Solo tú puedes quitarlas.',
        'friends_hint' => 'Reciben un correo con el enlace, y la lista aparece en su página de amigos.',
        'friends_none' => 'En cuanto alguien abre un enlace tuyo, os hacéis amigos y puedes compartir listas con esa persona por su nombre.',
        'rule' => 'Una regla lo atraviesa todo: la persona para quien es una lista nunca sabe qué se ha reservado. Ni quién, ni cuánto, ni que haya algo.',
        'summary' => 'Esto es lo que vas a crear',
        'shared_with_count' => 'compartida con :count',
        'after' => 'Después: ponerle cosas. Todo lo que encuentres en el sitio se guarda con una pulsación, y un enlace de cualquier otro sitio se pega en un momento.',
        'back' => 'Atrás',
        'next' => 'Siguiente',
        'sign_in_hint' => 'Inicia sesión para guardar esta lista. Tus respuestas se conservan mientras tanto.',
        'sign_in_and_create' => 'Iniciar sesión y crear la lista',
    ],

    'reminders' => [
        'birthday_title' => 'El cumpleaños de :name se acerca',
        'birthday_today_title' => 'Hoy es el cumpleaños de :name',
        'birthday_today' => 'Hoy es el día. Si ya va algo en camino, es también el momento de escribirle.',
    ...
    'notifications' => [
        ...
        'list_shared' => ':name compartió “:list” contigo',
        'list_suggestion' => 'Nueva sugerencia para “:list”',
        'list_item_added' => 'Alguien añadió algo a “:list”',
        'list_message' => 'Nuevo mensaje en “:list”',
        'list_pledge' => 'Alguien puso dinero para “:list”',
        'list_claimed' => 'Algo de “:list” ya está reservado',
        'list_claimed_item' => 'Reservado en “:list”: “:item”',
        'title' => 'Avisos',
        'recent' => 'Reciente',
    ...
    /*
     * Cómo funcionan las listas. En el orden en que uno se las encuentra —
     * buscar, guardar, consultar — y no en el orden en que están construidas:
    ...
    'lists_help' => [
        ...
        'intro' => 'Una lista es donde guardas lo que encuentras aquí — para ti, o para alguien a quien vas a regalar. No hace falta crearla antes: al guardar algo se te ofrece.',
        'link' => '¿Cómo funcionan las listas?',

        'step_find' => 'Encuentra algo que quieras guardar',
        'step_find_body' => 'Busca, o recorre una guía. Cada ficha de producto lleva un marcador, abajo a la derecha de la imagen.',
        ...
        'step_save_body' => 'Toca el marcador para guardarlo directamente, o la flecha pequeña de al lado para elegir la lista. Ahí mismo creas una nueva.',
        ...
        'step_open_body' => 'Todo lo que guardaste está en Mis listas. Cada lista muestra lo que contiene, si es privada y para quién es.',
        ...
        'making_from_save' => 'Mientras guardas un producto: abre el panel junto al marcador y elige crear una lista nueva. Lo que estabas guardando entra directamente en ella.',
        'making_from_lists' => 'Desde Mis listas: el botón de arriba a la derecha. Útil cuando ya sabes para qué es la lista antes de haber encontrado nada.',

        'private_title' => 'Quién puede verla',
        'private_body' => 'Una lista es privada hasta que la compartes. Si la compartes con quienes te van a regalar algo, pueden marcar lo que se llevan, y tú no ves quién se llevó qué, así que la sorpresa se mantiene.',
    ...
    /*
     * Las personas con las que compartes listas.
     *
     * Se crea al abrir el enlace de alguien e iniciar sesión después, o al
     * añadir una dirección aquí. Ver App\Services\Social\Friends.
     */
    'friends' => [
        'title' => 'Amigos',
        ...
        'they_see' => 'Tus listas que :name ve',
        'day' => 'Día',
        'month' => 'Mes',
        'their_birthday' => 'Su cumpleaños',
        'their_birthday_optional' => 'Su cumpleaños (opcional)',
        'add_birthday' => 'Añadir cumpleaños',
        ...
        'removed' => 'Quitado. Ya no estáis conectados.',
        'save' => 'Guardar',
        'add_title' => 'Añadir a alguien',
        'add_hint' => 'Por correo. Si ya tiene cuenta, quedáis conectados ahora; si no, en cuanto inicie sesión. No le enviamos ningún correo.',
        'email' => 'Su correo',
        'add' => 'Añadir',
        ...
        'see_birthday' => 'Mis amigos pueden ver mi cumpleaños',
