...
/**
 * One tab per kind, and an "All" that means it.
 *
    ...
    public function getTabs(): array
    {
        ...
        foreach (CoveKind::cases() as $kind) {
            $tabs[$kind->value] = Tab::make(Str::plural($kind->label()))
                ...
                // discover by clicking through to an empty table.
                ->badge(fn () => static::getResource()::getEloquentQuery()->where('kind', $kind->value)->count());
        }
