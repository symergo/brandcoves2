...
return [
    ...
    'lists' => [
        ...
        'others_shared_hint' => 'Wish lists and gift lists others shared with you. Add to them and choose what you would like to give.',
        ...
        'others_wish_shared' => 'Wish lists from others',
        ...
        'shared_intro' => ':name sees nothing. Let the others know what you are giving, so nobody gives twice.',
    ...
    */
    ...
    'wizard' => [
        ...
        'person_hint' => 'Pick a friend or type a name.',
        'occasion' => 'The occasion? (optional)',
        'occasion_hint_mine' => 'With a date it becomes a registry: people see what it is for and when. A delivery address can come later, visible only to whoever claims. We remind you two weeks before.',
        'occasion_hint_other' => 'Say what it is for and when. We remind you two weeks and five days before, and on the day.',
        'date_label' => 'Date',
        'date_known' => 'That falls on :date.',
        'date_other' => 'A different date',
        'date_from_birthday' => 'That birthday becomes the date.',
        'date_needs_birthday' => 'Fill in the birthday above; the date follows.',
        'date_needs_mine' => 'We do not know your birthday. Pick the date here, or add your birthday on the Friends page.',
        'sharing' => 'Who can see it?',
        'sharing_hint_mine' => 'Private: only you. Shared: anybody with the link claims what they are getting, so nothing is bought twice.',
        'sharing_hint_for_someone' => 'Private: your own notes. Shared: the other givers claim, add ideas and talk on the board.',
        'sharing_hint_group' => 'A group gift needs the others. Share the link: they vote, chip in and talk on the board.',
        'visibility_private' => 'Private (or share later)',
        'visibility_link' => 'Share with a link',
        'visibility_private_mine' => 'Only you. Share any time.',
        'visibility_link_mine' => 'Anybody with the link claims what they are getting. You hear nothing of it.',
        'visibility_private_for_someone' => 'Only you. Collect ideas quietly.',
        'visibility_link_for_someone' => 'The other givers claim what they take. The recipient sees nothing.',
        'visibility_private_group' => 'Only you, for now. Share once something is on it.',
        'visibility_link_group' => 'Anybody with the link votes, chips in and talks. The recipient sees nothing.',
        'can_add_hint' => 'Anybody with the link can add things. Only you can remove them.',
        'friends_hint' => 'They get an email with the link; the list also appears on their Friends page.',
        'friends_none' => 'Once somebody opens a link of yours, you become friends and can share by name.',
        'rule' => 'One rule always holds: whoever the list is for never sees what has been claimed.',
        'back' => 'Back',
        'next' => 'Next',
    ...
    'gift' => [
        ...
        'preference_label' => 'And which way does their taste go? (up to 3)',
        'preference_or' => 'or',
