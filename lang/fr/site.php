...
return [
    ...
    'wizard' => [
        ...
        'title_santa' => 'Lancez un groupe en trois étapes',
        'santa_sharing' => 'Comment le groupe se partage',
        'santa_sharing_hint' => 'Dès que le groupe existe, vous recevez un lien d’invitation. Envoyez-le à tout le monde : chacun rejoint avec un nom et une adresse e-mail, sans compte. Quand tout le monde est là, vous faites le tirage et chacun reçoit un nom par e-mail.',
        'santa_no_list_yet' => 'Vous n’avez pas encore de liste de souhaits. Dès que vous en créez une, vous pourrez y rattacher le groupe depuis sa page, pour que la personne qui vous tire ait de quoi partir.',
