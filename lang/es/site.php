...
return [
    ...
    'market_prompt' => [
        'title' => '¿Dónde compras?',
        'intro' => 'Tiendas, precios y envío cambian según el país. Elige el tuyo y lo recordaremos.',
        'guess' => 'Hemos supuesto :name por tu navegador. Pulsa Escape para mantenerlo.',
    ],
    ...
    'santa' => [
        ...
        'aka' => '(sorteo de nombres, o Secret Santa)',
        ...
        'your_list' => 'Tu lista de deseos',
        'your_list_hint' => 'Quien te saque ve esta lista, sin que tú veas quién es. Puedes cambiarla más tarde en la página del grupo.',
        'no_list_option' => 'Aún sin lista',
        'list_detached' => 'Ese grupo ya no ve ninguna lista tuya.',
        'how_it_works' => '¿Cómo funciona el Amigo Invisible?',
    ],
    'quiz' => [
    ...
    'wizard' => [
        ...
        'title_placeholder_santa' => 'Oficina 2026, Navidad en familia…',
        'title_santa' => 'Crea un grupo en tres pasos',
        'santa_sharing' => 'Así se comparte el grupo',
        'santa_sharing_hint' => 'En cuanto exista el grupo recibes un enlace de invitación. Envíaselo a todos: se unen con un nombre y un correo, sin cuenta. Cuando estén todos, haces el sorteo y cada uno recibe un nombre por correo.',
        'santa_no_list_yet' => 'Aún no tienes lista de deseos. En cuanto hagas una, podrás vincular el grupo a ella desde la página del grupo, para que quien te saque tenga por dónde empezar.',
        'sign_in_and_create_santa' => 'Inicia sesión y crea el grupo',
