...
return [
    ...
    'search' => [
        ...
        'watch' => 'Hou me op de hoogte',
        'watch_hint' => 'We kijken één keer per dag en laten weten als er iets nieuws bij deze zoekopdracht past.',
        'watch_price_label' => 'Alleen onder (optioneel)',
        'watch_confirm' => 'Deze zoekopdracht volgen',
        'watching' => 'Je volgt deze zoekopdracht',
        'watching_under' => 'Je volgt deze zoekopdracht, onder :price',
        'stop_watching' => 'Stoppen',
        'watch_sign_in' => 'Log in om een zoekopdracht te volgen',
        'watch_created' => 'We laten je weten als er nieuwe vondsten zijn voor deze zoekopdracht.',
        'watch_removed' => 'Je volgt deze zoekopdracht niet meer.',
        'watch_needs_term' => 'Typ eerst iets om te volgen.',
        ...
        'landing_brands' => 'Merken van je lijsten',
        'landing_tools' => 'Andere manieren om iets te vinden',
        'landing_suggest_title' => 'Laat anderen ideeën aandragen',
        'landing_suggest_body' => 'Maak een gedeelde verlanglijst: wie de link heeft, stelt dingen voor en jij kiest.',
    ...
    'lists' => [
        ...
        'others_shared_hint' => 'Verlanglijsten en cadeaulijsten die anderen met jou deelden. Vul ze aan en kies wat je graag geeft.',
        ...
        'others_wish_shared' => 'Verlanglijsten van anderen',
        ...
        'make_new' => 'Maak een nieuwe lijst',
        'list_name' => 'Naam van de lijst',
        'create' => 'Lijst maken',
        'for_someone' => 'Deze lijst is voor iemand anders',
        'for_whom' => 'Voor wie is het?',
        'empty' => 'Nog niets bewaard.',
        'empty_hint' => 'Zoek een product en druk op Bewaren.',
        'empty_list' => 'Deze lijst is leeg.',
        ...
        'empty_for_someone_step3' => 'Wie iets koopt, claimt het, zodat niemand hetzelfde koopt.',
        ...
        'items' => ':count items',
        'one_item' => '1 item',
        'added' => 'Bewaard in je lijst.',
        'removed' => 'Verwijderd.',
        'remove' => 'Verwijderen',
        'save' => 'Bewaren',
        'saved' => 'Bewaard',
        'save_to_list' => 'Bewaar in een lijst',
        'save_to' => 'Bewaar in :list',
        'remove_from' => 'Haal uit :list',
        'delete_list' => 'Deze lijst verwijderen',
        'delete' => 'Verwijderen',
        ...
        'remove_confirm' => ':title van deze lijst halen?',
        ...
        'from_your_friends' => 'Uit je vrienden',
        'copy_to' => 'Kopieer naar een andere lijst',
        'copy_to_which' => 'Naar welke lijst?',
        'copied_to' => 'Gekopieerd naar :list.',
        'add_to_my_list' => 'Zet op mijn lijst',
        ...
        'price_now' => 'Nu :price',
        'sign_in_to_keep' => 'Log in om je lijsten te bewaren',
        ...
        'role_editor' => 'Kan toevoegen',
        'adding_allowed' => 'Toevoegen mag',
        'share_email' => 'E-mail',
        'friends' => 'Lijsten van vrienden',
        'friends_empty' => 'Niemand die je volgt heeft al een openbare lijst.',
        'follow' => 'Volgen',
        'unfollow' => 'Ontvolgen',
        'followed' => 'Je volgt ze nu.',
        'shared_intro_anon' => 'Tik op iets om aan te geven dat jij het koopt. Wie deze lijst maakte, ziet niet wie wat geclaimd heeft.',
        'shared_intro_gift' => 'Deze cadeaulijst wordt gedeeld met meerdere personen. Geef aan wat jij koopt, dan koopt niemand hetzelfde.',
        ...
        'cancel' => 'Annuleren',
        'share_text' => 'Dit is mijn lijst: :title',
        ...
        'shared_by' => ':name deelde deze lijst',
        'for_line' => 'Voor :name',
        'owner_role' => 'Eigenaar van deze lijst',
        ...
        'owner_view_note' => 'Dit is je eigen lijst, dus je ziet niet wat er gekocht is, dat is de bedoeling.',
    ],
    ...
    'recipients' => [
        ...
        'claim_is_you' => 'Dit is de link die jij hun stuurt. Jij hebt deze lijst gemaakt, dus die kan niet van jou zijn: zij klikken aan hun kant op "dit ben ik".',
        'claim_sign_in' => 'Meld je aan om te zeggen dat jij dit bent. Dan wordt dit je eigen lijst, die je met iedereen kunt delen.',
        'claim_hint' => 'Koppel dit aan je account, dan verschijnen je eigen lijsten wanneer ze voor je zoeken.',
    ...
    'santa' => [
        ...
        'draw' => 'Trekken',
        'draw_confirm' => 'De trekking doen voor :count mensen? Iedereen krijgt een e-mail met een naam, en die kun je niet terughalen.',
        'draw_needs_two' => 'Voor de trekking zijn minstens twee mensen nodig.',
        'members_count' => ':count mensen',
        ...
        'no_list' => ':name heeft geen lijst gemaakt. Je staat er alleen voor, maar we helpen.',
        'build_yours' => 'Maak eerst je eigen lijst',
        ...
        'email_list' => 'Ze hebben een lijst gemaakt. Kijk maar:',
        'email_no_list' => 'Ze hebben nog geen lijst gemaakt, dus je gaat blind. Daar helpen we bij:',
        'attach_hint' => 'Koppel een groep aan deze lijst, zodat wie jou getrokken heeft iets heeft om op af te gaan.',
        'attach_list' => 'Gebruik deze lijst',
        'list_attached' => 'Die groep ziet deze lijst nu.',
        ...
        'delete_confirm_drawn' => ':title verwijderen? Er is al getrokken, dus iedereen raakt de getrokken naam kwijt, en niemand krijgt bericht. Zeg het hen eerst zelf.',
        'deleted' => 'Groep verwijderd.',
        'email_hint' => 'Zodat degene die jou trekt jouw naam te zien krijgt. Niemand anders ziet het.',
        'your_list' => 'Je verlanglijst',
        'your_list_hint' => 'Wie jou trekt, ziet deze lijst, zonder dat jij ziet wie het is. Je kunt het later nog wijzigen op de groepspagina.',
        'no_list_option' => 'Nog geen lijst',
        'list_detached' => 'Die groep ziet geen lijst van jou meer.',
        'how_it_works' => 'Hoe werkt Geheime Vriend?',
    ],
    'quiz' => [
        'title' => 'Hoe goed ken je ze?',
        'intro' => 'Vier dingen. Een ervan staat echt op de lijst van :name. Kies welke.',
        'create' => 'Maak een quiz van deze lijst',
        'created' => 'Quiz klaar. Stuur hem naar wie je wilt.',
        'too_short' => 'Je hebt minstens :count dingen op de lijst nodig voordat een quiz leuk is.',
        'share_first' => 'Deel de lijst eerst. Een quiz laat zien wat erop staat.',
        'round' => 'Ronde :current van :total',
        'submit' => 'Bekijk je score',
        'answered_of' => ':answered van :total beantwoord',
        'score' => 'Je had er :score van de :total goed',
        'share' => 'Deel je score',
        'played' => ':count mensen hebben gespeeld',
        'average' => 'Gemiddelde score :score',
        'owner_note' => 'Dit is je eigen lijst, dus je mag niet meedoen. Dat zou valsspelen zijn.',
        'missed' => 'Wat je miste',
        ...
        'intro_own' => 'Deel deze lijst als een quiz: vier dingen, één ervan staat echt op je lijst.',
        'share_text' => 'Hoe goed ken je mij?',
        'own_title' => 'Kom te weten hoe goed je vrienden je kennen!',
        'open' => 'Open de quiz',
        'intro_anon' => 'Vier dingen. Een ervan staat echt op hun lijst. Kies welke.',
        'badge' => 'Quiz',
    ],
    'preview' => [
        'badge' => 'Voorbeeld',
    ...
    'gift_cove' => [
        ...
        'seo_description' => 'Verlanglijsten, een lijst voor iemand anders, samen kopen, Geheime Vriend, prijsalarmen en cadeau-ideeen op een plek. Niemand ziet wie wat kocht.',
        ...
        'intro' => 'Alles om voor anderen te kopen, en om te vertellen wat je zelf leuk zou vinden.',
        'tools' => 'Wat je hier kunt doen',
        'band_together' => 'Samen met anderen',
        'band_inspire' => 'Inspiratie opdoen',
        'search_title' => 'Zoeken en vergelijken',
        'search_body' => 'Vind een product bij de winkels van jouw land en zie wie het het goedkoopst verkoopt. Op je telefoon scan je de streepjescode.',
        'ask_title' => 'Vraag het aan anderen',
        'ask_body' => 'Beschrijf voor wie je iets zoekt en laat de community iets voorstellen. Elk antwoord komt met echte producten en een prijs.',
        'alerts_title' => 'Meldingen',
        'alerts_body' => 'Iemand deelt een lijst met je, doet een suggestie, iemand uit je vriendenlijst is bijna jarig, een prijs zakt: je hoort het hier en per mail.',
        'friends_title' => 'Vrienden',
        'friends_body' => 'De mensen met wie je lijsten deelt, met hun verjaardag erbij, zodat er twee weken van tevoren een herinnering komt.',
        'daily_title' => 'De Cove van de dag',
        ...
        'wishlist_title' => 'Deel je eigen wenslijst',
        'wishlist_body' => 'Bewaar wat je leuk zou vinden en deel de link. Wie hem opent, claimt wat ze kopen, zodat niets twee keer gekocht wordt. Daar zie jij nooit iets van.',
        'wishlist_step1' => 'Zoek iets dat je leuk vindt en druk op de bladwijzer erop. De keuzelijst vraagt naar welke lijst het moet; kies je eigen.',
        'wishlist_step2' => 'Open de lijst en druk op Delen. Daarmee gaat de link aan en zie je hem staan, klaar om te sturen naar wie ernaar vraagt.',
        ...
        'giftlist_body' => 'Verzamel ideeen voor een persoon. Hou het voor jezelf, of deel het: dan bouwen jullie de lijst samen en claimt iedereen wat er gekocht wordt, zodat niets twee keer gekocht wordt.',
        'giftlist_step1' => 'Druk op Nieuwe lijst, kies "Voor iemand anders" en geef de persoon een naam. Deze kaart opent dat formulier meteen op die stand.',
        'giftlist_step2' => 'Zet er dingen op zodra je ze tegenkomt, net als bij elk andere lijst.',
        ...
        'handover_step1' => 'Open de lijst en stuur hen de link "Vraag het hen zelf", zodat er een account is om het aan te geven.',
        ...
        'handover_step3' => 'Bevestig, en de lijst is van hen: zij kunnen hem delen en anderen kunnen eruit claimen.',
        ...
        'suggestions_step2' => 'Komt er een binnen, dan wacht hij bovenaan de lijst, met de naam van wie hem stuurde.',
        ...
        'giftlist_cta' => 'Begin een lijst voor iemand',
        'split_title' => 'Apart kopen voor een persoon',
        'split_body' => 'Deel een lijst over iemand met de andere gevers. Wie iets koopt, claimt het, zodat niemand hetzelfde koopt.',
        'split_cta' => 'Begin met afstemmen',
        'handover_cta' => 'Geef een lijst door',
        'build_title' => 'Samen een lijst bouwen',
        'build_body' => 'Zet "iedereen kan toevoegen" aan en iedereen met de link zet er dingen op. Alleen toevoegen: niemand behalve jij haalt iets weg.',
        'build_cta' => 'Open een lijst om te delen',
        'collab_cta' => 'Start een groepscadeau',
        'board_title' => 'Babbelen over een lijst',
        'board_body' => 'Naast elke gedeelde lijst staat een prikbord, alleen voor de gevers. Degene voor wie de lijst is, ziet het nooit.',
        'board_cta' => 'Open een gedeelde lijst',
        'santa_cta' => 'Start een groep',
        'quiz_cta' => 'Maak een quiz',
        'friends_cta' => 'Bekijk mijn vrienden',
        'whisperer_cta' => 'Beschrijf iemand',
        'search_cta' => 'Zoeken',
        'ask_cta' => 'Stel je vraag',
        'alerts_cta' => 'Bekijk mijn meldingen',
        'daily_cta' => 'Bekijk vandaag',
        'guides_cta' => 'Lees de gidsen',
        'ideas_cta' => 'Blader door ideeen',
        'surprise_cta' => 'Verras me',
    ],

    'wizard' => [
        'title' => 'Een lijst in drie stappen',
        'step_of' => 'Stap :step van :total',
        'step_kind' => 'Voor wie',
        'step_details' => 'Naam en gelegenheid',
        'step_sharing' => 'Delen',
        'kind_hint' => 'Dit bepaalt wat de lijst kan. Later niet te veranderen.',
        'title_for' => 'Voor :name',
        ...
        'title_placeholder_group' => 'Een cadeau voor Sam van ons allemaal…',
        'title_placeholder_santa' => 'Kantoor 2026, Kerst met de familie…',
        'title_santa' => 'Een groep in drie stappen',
        'santa_sharing' => 'Zo deel je de groep',
        'santa_sharing_hint' => 'Na het aanmaken krijg je een uitnodigingslink. Wie hem opent, doet mee met naam en e-mail, zonder account. Zijn ze allemaal binnen, dan trek jij en krijgt iedereen één naam per e-mail.',
        'santa_no_list_yet' => 'Nog geen verlanglijst? Maak er een en koppel hem later op de groepspagina.',
        'sign_in_and_create_santa' => 'Log in en start de groep',
        'person' => 'Voor wie is het?',
        'person_hint' => 'Kies een vriend of typ een naam.',
        'occasion' => 'De gelegenheid? (optioneel)',
        'occasion_hint_mine' => 'Met een datum wordt het een geschenkenlijst: mensen zien waarvoor en wanneer. Een bezorgadres kan later, alleen zichtbaar voor wie claimt. Twee weken vooraf herinneren we je.',
        'occasion_hint_other' => 'Zeg waarvoor en wanneer. We herinneren je twee weken en vijf dagen vooraf, en op de dag zelf.',
        'date_label' => 'Datum',
        'date_known' => 'Dat valt op :date.',
        'date_other' => 'Andere datum',
        'date_from_birthday' => 'Die verjaardag wordt de datum.',
        'date_needs_birthday' => 'Vul hierboven de verjaardag in; de datum volgt vanzelf.',
        'date_needs_mine' => 'We kennen je verjaardag niet. Kies hier de datum, of zet je verjaardag op de vriendenpagina.',
        'sharing' => 'Wie mag het zien?',
        'sharing_hint_mine' => 'Privé: alleen jij. Gedeeld: iedereen met de link claimt wat ze kopen, zodat niets dubbel gaat.',
        'sharing_hint_for_someone' => 'Privé: je eigen notities. Gedeeld: de andere gevers claimen, voegen ideeën toe en overleggen op het prikbord.',
        'sharing_hint_group' => 'Een groepscadeau heeft de anderen nodig. Deel de link: ze stemmen, leggen in en overleggen op het prikbord.',
        'visibility_private' => 'Privé (of deel later)',
        'visibility_link' => 'Delen via een link',
        'visibility_private_mine' => 'Alleen jij. Delen kan altijd nog.',
        'visibility_link_mine' => 'Iedereen met de link claimt wat ze kopen. Jij hoort daar niets van.',
        'visibility_private_for_someone' => 'Alleen jij. Stilletjes ideeën verzamelen.',
        'visibility_link_for_someone' => 'De andere gevers claimen wat ze nemen. De ontvanger ziet niets.',
        'visibility_private_group' => 'Voorlopig alleen jij. Deel zodra er iets op staat.',
        'visibility_link_group' => 'Iedereen met de link stemt, legt in en overlegt. De ontvanger ziet niets.',
        'can_add_hint' => 'Iedereen met de link kan dingen toevoegen. Alleen jij kunt weghalen.',
        'friends_hint' => 'Ze krijgen een mail met de link; de lijst staat ook op hun vriendenpagina.',
        'friends_none' => 'Zodra iemand een link van jou opent, worden jullie vrienden en kun je op naam delen.',
        'rule' => 'Eén regel geldt altijd: wie de lijst voor is, ziet nooit wat er geclaimd is.',
        'back' => 'Terug',
        'next' => 'Volgende',
        'sign_in_hint' => 'Log in om de lijst te bewaren. Je antwoorden blijven staan.',
        'sign_in_and_create' => 'Log in en maak de lijst',
    ],

    'reminders' => [
        'birthday_title' => 'De verjaardag van :name komt eraan',
        'birthday_today_title' => ':name is vandaag jarig',
        'birthday_today' => 'Vandaag is het zover. Als er iets onderweg is, is dit ook het moment voor een berichtje.',
        ...
        'list_lead_mine' => 'Nog :days dagen. Een goed moment om te kijken of je lijst zegt wat je wilt.',
    ...
    'notifications' => [
        ...
        'list_shared' => ':name deelde “:list” met jou',
        'list_suggestion' => 'Nieuwe suggestie voor “:list”',
        'list_item_added' => 'Iemand voegde iets toe aan “:list”',
        'list_message' => 'Nieuw bericht op “:list”',
        'list_pledge' => 'Iemand legde geld bij voor “:list”',
        'list_claimed' => 'Er is iets gereserveerd op “:list”',
        'list_claimed_item' => 'Gereserveerd op “:list”: “:item”',
        'title' => 'Meldingen',
        'recent' => 'Recent',
    ...
    'ask' => [
        ...
        'detail_placeholder' => 'Wat die persoon leuk vindt, wat je al hebt afgestreept, hoe goed jullie elkaar kennen.',
        'budget_label' => 'Tot',
    ...
    'daily' => [
        ...
        'day_themes' => [
            ...
            'holiday_packing' => ['title' => 'Voor je vertrekt', 'blurb' => 'De lijst die je onderweg naar de luchthaven opstelt.'],
            ...
            'sinterklaas_run_up' => ['title' => 'Voor pakjesavond', 'blurb' => 'De lijst, nu er nog voorraad is.'],
    ...
    'entity_rails' => [
        ...
        'wishlisted' => [
            'title' => 'Vaak op verlanglijsten',
            'blurb' => 'Wat bezoekers hier op een lijst zetten. Alleen als meerdere lijsten het delen.',
        ],
    ...
    /*
     * Hoe lijsten werken. In de volgorde waarin iemand het tegenkomt — zoeken,
     * bewaren, bekijken — en niet in de volgorde waarin het gebouwd is, want
     * niemand maakt eerst een leeg lijst en gaat daarna pas zoeken.
     */
    'lists_help' => [
    ...
    'help' => [
        'seo_title' => 'Help',
        'seo_description' => 'Hoe je zoekt, hoe lijsten werken, en waar je ons vertelt dat er iets mis is.',
        'title' => 'Help',
    ...
    /*
     * De mensen met wie je lijsten deelt.
     *
     * Ontstaat door iemands deellink te openen en daarna in te loggen, of door
     * hier een adres toe te voegen. Zie App\Services\Social\Friends.
     */
    'friends' => [
        'title' => 'Vrienden',
        ...
        'they_share' => 'Lijsten van :name',
        'they_see' => 'Jouw lijsten die :name ziet',
        'day' => 'Dag',
        'month' => 'Maand',
        'their_birthday' => 'Hun verjaardag',
        'their_birthday_optional' => 'Hun verjaardag (optioneel)',
        ...
        'removed' => 'Verwijderd. Jullie zijn niet meer verbonden.',
        'save' => 'Opslaan',
        'add_title' => 'Iemand toevoegen',
        'add_hint' => 'Op e-mailadres. Heeft die persoon al een account, dan zijn jullie nu verbonden; zo niet, dan gebeurt dat zodra ze inloggen. We mailen niemand.',
        ...
        'see_birthday' => 'Vrienden mogen mijn verjaardag zien',
