...
return [
    ...
    'lists' => [
        ...
        'others_wish_shared' => 'Listes de souhaits des autres',
    ...
    'santa' => [
        ...
        'aka' => '(tirage au sort, ou Secret Santa)',
        ...
        'your_list' => 'Votre liste de souhaits',
        'your_list_hint' => 'La personne qui vous tire voit cette liste, sans que vous sachiez qui c’est. Vous pourrez la changer plus tard sur la page du groupe.',
        'no_list_option' => 'Pas encore de liste',
        'list_detached' => 'Ce groupe ne voit plus de liste à vous.',
        'how_it_works' => 'Comment fonctionne l’Ami secret ?',
    ],
    'quiz' => [
    ...
    'wizard' => [
        'title' => 'Une liste en trois étapes',
        ...
        'title_placeholder_santa' => 'Bureau 2026, Noël en famille…',
        'title_santa' => 'Un groupe en trois étapes',
        'santa_sharing' => 'Comment partager le groupe',
        'santa_sharing_hint' => 'Une fois le groupe créé, vous recevez un lien d’invitation. Qui l’ouvre rejoint avec un nom et un e-mail, sans compte. Quand tout le monde est là, vous tirez, et chacun reçoit un nom par e-mail.',
        'santa_no_list_yet' => 'Pas encore de liste de souhaits ? Créez-en une et rattachez-la plus tard sur la page du groupe.',
        'sign_in_and_create_santa' => 'Connectez-vous et lancez le groupe',
        'person' => 'Pour qui est-ce ?',
        'person_hint' => 'Choisissez un ami ou tapez un nom.',
        'occasion' => 'L\'occasion ? (facultatif)',
        'occasion_hint_mine' => 'Avec une date, elle devient une liste de cadeaux : chacun voit pour quoi et quand. Une adresse de livraison peut venir ensuite, visible seulement de qui réserve. Nous vous rappelons deux semaines avant.',
        'occasion_hint_other' => 'Dites pour quoi et quand. Nous vous rappelons deux semaines et cinq jours avant, et le jour même.',
        'date_label' => 'Date',
        'date_known' => 'Cela tombe le :date.',
        'date_other' => 'Une autre date',
        'date_from_birthday' => 'Cet anniversaire devient la date.',
        'date_needs_birthday' => 'Indiquez l’anniversaire ci-dessus ; la date suit.',
        'date_needs_mine' => 'Nous ne connaissons pas votre anniversaire. Choisissez la date ici, ou ajoutez votre anniversaire sur la page Amis.',
        'sharing' => 'Qui peut la voir ?',
        'sharing_hint_mine' => 'Privée : vous seul. Partagée : toute personne avec le lien réserve ce qu’elle offre, pour éviter les doublons.',
        'sharing_hint_for_someone' => 'Privée : vos propres notes. Partagée : les autres donateurs réservent, ajoutent des idées et discutent sur le tableau.',
        'sharing_hint_group' => 'Un cadeau commun a besoin des autres. Partagez le lien : ils votent, participent et discutent sur le tableau.',
        'visibility_private' => 'Privée (ou partager plus tard)',
        'visibility_link' => 'Partager par un lien',
        'visibility_private_mine' => 'Vous seul. Partagez quand vous voulez.',
        'visibility_link_mine' => 'Toute personne avec le lien réserve ce qu’elle offre. Vous n’en saurez rien.',
        'visibility_private_for_someone' => 'Vous seul. Pour rassembler des idées discrètement.',
        'visibility_link_for_someone' => 'Les autres donateurs réservent ce qu’ils prennent. Le destinataire ne voit rien.',
        'visibility_private_group' => 'Vous seul, pour l’instant. Partagez dès qu’il y a quelque chose dessus.',
        'visibility_link_group' => 'Toute personne avec le lien vote, participe et discute. Le destinataire ne voit rien.',
        'can_add_hint' => 'Toute personne avec le lien peut ajouter des choses. Vous seul pouvez en retirer.',
        'friends_hint' => 'Ils reçoivent un e-mail avec le lien ; la liste apparaît aussi sur leur page Amis.',
        'friends_none' => 'Dès que quelqu’un ouvre un de vos liens, vous devenez amis et pouvez partager par nom.',
        'rule' => 'Une règle vaut toujours : la personne à qui la liste est destinée ne voit jamais ce qui est réservé.',
        'back' => 'Retour',
        'next' => 'Suivant',
        'sign_in_hint' => 'Connectez-vous pour garder la liste. Vos réponses restent.',
    ...
    'gift' => [
        ...
        'preference_label' => 'Et vers quoi vont leurs goûts ? (3 maximum)',
        'preference_or' => 'ou',
