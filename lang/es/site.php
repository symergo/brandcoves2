...
return [
    ...
    'lists' => [
        ...
        'others_wish_shared' => 'Listas de deseos de otros',
    ...
    'wizard' => [
        ...
        'title_santa' => 'Un grupo en tres pasos',
        'santa_sharing' => 'Cómo compartir el grupo',
        'santa_sharing_hint' => 'Al crear el grupo recibes un enlace de invitación. Quien lo abre se une con un nombre y un correo, sin cuenta. Cuando estén todos, haces el sorteo y cada uno recibe un nombre por correo.',
        'santa_no_list_yet' => '¿Aún sin lista de deseos? Haz una y vincúlala luego en la página del grupo.',
        'sign_in_and_create_santa' => 'Inicia sesión y crea el grupo',
        'person' => '¿Para quién es?',
        'person_hint' => 'Elige un amigo o escribe un nombre.',
        'occasion' => '¿La ocasión? (opcional)',
        'occasion_hint_mine' => 'Con una fecha se convierte en lista de regalos: la gente ve para qué y cuándo. La dirección de entrega puede ir después, visible solo para quien reserva. Te avisamos dos semanas antes.',
        'occasion_hint_other' => 'Di para qué y cuándo. Te avisamos dos semanas y cinco días antes, y el mismo día.',
        'date_label' => 'Fecha',
        'date_known' => 'Cae el :date.',
        'date_other' => 'Otra fecha',
        'date_from_birthday' => 'Ese cumpleaños pasa a ser la fecha.',
        'date_needs_birthday' => 'Rellena arriba el cumpleaños; la fecha sale sola.',
        'date_needs_mine' => 'No sabemos tu cumpleaños. Elige aquí la fecha, o añade tu cumpleaños en la página de Amigos.',
        'sharing' => '¿Quién puede verla?',
        'sharing_hint_mine' => 'Privada: solo tú. Compartida: cualquiera con el enlace reserva lo que regala, y nada se compra dos veces.',
        'sharing_hint_for_someone' => 'Privada: tus propias notas. Compartida: los demás reservan, añaden ideas y hablan en el tablón.',
        'sharing_hint_group' => 'Un regalo en grupo necesita a los demás. Comparte el enlace: votan, aportan y hablan en el tablón.',
        'visibility_private' => 'Privada (o compartir después)',
        'visibility_link' => 'Compartir con un enlace',
        'visibility_private_mine' => 'Solo tú. Comparte cuando quieras.',
        'visibility_link_mine' => 'Cualquiera con el enlace reserva lo que regala. Tú no te enteras de nada.',
        'visibility_private_for_someone' => 'Solo tú. Para reunir ideas sin que se note.',
        'visibility_link_for_someone' => 'Los demás reservan lo que llevan. Quien recibe no ve nada.',
        'visibility_private_group' => 'Solo tú, por ahora. Comparte en cuanto haya algo.',
        'visibility_link_group' => 'Cualquiera con el enlace vota, aporta y habla. Quien recibe no ve nada.',
        'can_add_hint' => 'Cualquiera con el enlace puede añadir cosas. Solo tú puedes quitarlas.',
        'friends_hint' => 'Reciben un correo con el enlace; la lista aparece también en su página de Amigos.',
        'friends_none' => 'En cuanto alguien abre un enlace tuyo, os hacéis amigos y puedes compartir por nombre.',
        'rule' => 'Una regla vale siempre: la persona para quien es la lista nunca ve lo que se ha reservado.',
        'back' => 'Atrás',
        'next' => 'Siguiente',
        'sign_in_hint' => 'Inicia sesión para guardar la lista. Tus respuestas se quedan.',
