...
return [
    ...
    'lists' => [
        ...
        'remove_confirm' => ':title van dit lijstje halen?',
    ...
    'santa' => [
        ...
        'your_list' => 'Je verlanglijstje',
        'your_list_hint' => 'Wie jou trekt, ziet dit lijstje, zonder dat jij ziet wie het is. Je kunt het later nog wijzigen op de groepspagina.',
        'no_list_option' => 'Nog geen lijstje',
        'list_detached' => 'Die groep ziet geen lijstje van jou meer.',
    ...
    'gift_cove' => [
        ...
        'seo_description' => 'Verlanglijstjes, een lijst voor iemand anders, samen kopen, Geheime Vriend, prijsalarmen en cadeau-ideeen op een plek. Niemand ziet wie wat kocht.',
        ...
        'friends_body' => 'De mensen met wie je lijstjes deelt, met hun verjaardag erbij, zodat er twee weken van tevoren een herinnering komt.',
        ...
        'ideas_body' => 'Ideeen per persoon, gelegenheid en budget, elk meteen op een lijstje te zetten.',
    ...
    'wizard' => [
        ...
        'step_sharing' => 'Delen',
        'kind_hint' => 'Dit bepaalt wat het lijstje kan. Al het andere kun je later veranderen; dit niet.',
        'title_for' => 'Voor :name',
        'kind_mine_body' => 'Dingen die je graag wilt. Hou hem voor jezelf, of deel hem: dan claimen mensen wat ze kopen, zodat niets twee keer gekocht wordt. Jij ziet nooit wat, of wie.',
        'kind_for_someone_body' => 'Een lijst over iemand anders. Hou hem voor jezelf als voorwerk, of deel hem: dan bouwen jullie hem samen en verdeel je het kopen, zodat niemand hetzelfde koopt.',
        'kind_group_body' => 'Met meerdere mensen een cadeau kopen. Iedereen stemt, legt in, en een van jullie koopt het.',
        'title_placeholder_mine' => 'Mijn verjaardag, Dingen die ik leuk vind…',
        'title_placeholder_for_someone' => 'Ideeen voor papa, Anna wordt 30…',
        'title_placeholder_group' => 'Een cadeau voor Sam van ons allemaal…',
        'title_placeholder_santa' => 'Kantoor 2026, Kerst met de familie…',
        'title_santa' => 'Start een groep in drie stappen',
        'santa_sharing' => 'Zo wordt de groep gedeeld',
        'santa_sharing_hint' => 'Zodra de groep bestaat, krijg je een uitnodigingslink. Stuur die naar iedereen: ze doen mee met een naam en een e-mailadres, zonder account. Zijn ze allemaal binnen, dan doe jij de trekking en krijgt iedereen één naam per e-mail.',
        'santa_no_list_yet' => 'Je hebt nog geen verlanglijstje. Zodra je er een maakt, kun je de groep er vanaf de groepspagina op wijzen, zodat wie jou trekt iets heeft om op af te gaan.',
        'sign_in_and_create_santa' => 'Log in en start de groep',
        'person' => 'Voor wie is het?',
        'person_hint' => 'Kies een van je vrienden om het lijstje aan hun account te koppelen, of typ een naam voor iemand die hier niet is.',
        'occasion' => 'Een gelegenheid? (optioneel)',
        'occasion_hint_mine' => 'Een wenslijst met een datum is een geschenkenlijst: mensen zien waarvoor en wanneer. Op het lijstje kun je daarna een bezorgadres zetten, alleen zichtbaar voor wie iets claimt. Twee weken van tevoren herinneren we je.',
        'occasion_hint_other' => 'Zeg waarvoor en wanneer, en we herinneren je twee weken van tevoren, vijf dagen ervoor en op de dag zelf.',
        'date_label' => 'Datum',
        'date_known' => 'Dat valt op :date.',
        'date_other' => 'Andere datum',
        'date_from_birthday' => 'We zetten die verjaardag als datum op het lijstje.',
        'date_needs_birthday' => 'Vul hierboven hun verjaardag in, dan komt de datum vanzelf mee.',
        'date_needs_mine' => 'We kennen jouw verjaardag niet, dus kies hier de datum. Je verjaardag zet je op de vriendenpagina.',
        'sharing' => 'Wie mag het zien?',
        'sharing_hint_mine' => 'Prive betekent alleen jij. Delen betekent dat iedereen met de link hem kan openen en claimen wat ze kopen, zodat niets twee keer gekocht wordt.',
        'sharing_hint_for_someone' => 'Prive betekent alleen jij: je eigen notities over die persoon. Deel hem en de andere gevers kunnen claimen, ideeen toevoegen en babbelen op het prikbord.',
        'sharing_hint_group' => 'Een groepscadeau heeft de anderen nodig: deel hem en stuur ze de link. Ze stemmen, leggen in en babbelen op het prikbord.',
        'visibility_private' => 'Privé (of deel later)',
        'visibility_link' => 'Delen via een link',
        'visibility_private_mine' => 'Alleen jij ziet hem. Delen kan altijd nog.',
        'visibility_link_mine' => 'Iedereen met de link ziet hem en claimt wat ze kopen, zodat niets twee keer gekocht wordt. Daarvan bereikt jou nooit iets.',
        'visibility_private_for_someone' => 'Alleen jij ziet hem. Handig om stilletjes ideeen te verzamelen.',
        'visibility_link_for_someone' => 'De andere gevers zien hem, claimen wat zij nemen, en degene voor wie het is komt niets te weten.',
        'visibility_private_group' => 'Voorlopig alleen jij. Delen kan zodra er iets op staat.',
        'visibility_link_group' => 'Iedereen met de link stemt, legt in en babbelt. Degene voor wie het is ziet het nooit.',
        'can_add_hint' => 'Bouw het lijstje samen: iedereen met de link kan er dingen op zetten. Alleen jij kunt iets weghalen.',
        'friends_hint' => 'Ze krijgen een mail met de link, en het lijstje verschijnt op hun vriendenpagina.',
        'friends_none' => 'Zodra iemand een link van jou opent, worden jullie vrienden en kun je lijstjes op naam delen.',
        'rule' => 'Een regel loopt overal doorheen: degene voor wie een lijst is, komt nooit te weten wat er geclaimd is. Niet wie, niet hoeveel, en niet dat er iets is.',
        'back' => 'Terug',
        'next' => 'Volgende',
        'sign_in_hint' => 'Log in om dit lijstje te bewaren. Je antwoorden blijven intussen staan.',
        'sign_in_and_create' => 'Log in en maak het lijstje',
    ],
    ...
    'friends' => [
        ...
        'they_see' => 'Jouw lijstjes die :name ziet',
        'day' => 'Dag',
        'month' => 'Maand',
