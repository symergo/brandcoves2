...
return [
    'nav' => [
        ...
        'dial' => "Explorer selon l'humeur",
        'hint_dial' => 'Un curseur, des valeurs sûres aux surprises',
        'share' => 'Partager',
        'close' => 'Fermer',
    ...
    'wizard' => [
        ...
        'summary' => 'Voici ce que vous créez',
        'shared_with_count' => 'partagée avec :count',
        'after' => 'Ensuite : y mettre des choses. Tout ce que vous trouvez sur le site s\'y enregistre d\'une pression, et un lien venu d\'ailleurs se colle en un instant.',
        'back' => 'Retour',
        'next' => 'Suivant',
    ...
    'lists_help' => [
        ...
        'private_body' => 'Une liste est privée tant que vous ne la partagez pas. Si vous la partagez avec les personnes qui vous offrent quelque chose, elles peuvent cocher ce qu\'elles prennent, et vous ne voyez pas qui a pris quoi : la surprise reste entière.',
