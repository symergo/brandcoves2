...
return [
    ...
    'search' => [
        ...
        'watch' => 'Tell me about new finds',
        'watch_hint' => 'We look once a day and tell you when something new matches this search.',
        'watch_price_label' => 'Only under (optional)',
        'watch_confirm' => 'Watch this search',
        'watching' => 'Watching this search',
        'watching_under' => 'Watching this search, under :price',
        'stop_watching' => 'Stop',
        'watch_sign_in' => 'Sign in to watch a search',
        'watch_created' => 'We will tell you about new finds for this search.',
        'watch_removed' => 'No longer watching this search.',
        'watch_needs_term' => 'Type something to watch first.',
         ...
         * citation. The component prints the storefront's host under the label
         * rather than leaving "Amazon" to mean whichever country they expect —
         * a Belgian visitor landing on amazon.com.be should have been told so
         * before the click, not after it. It is the bare domain and carries no
         * key: it had a verb in front of it ("Opens amazon.nl") on a control
    ...
    'lists' => [
        ...
        'empty_for_someone_step3' => 'Whoever buys something claims it, so nobody buys the same thing twice.',
        ...
        'remove_confirm' => 'Remove :title from this list?',
        ...
        'role_editor' => 'Can add items',
        'adding_allowed' => 'Adding allowed',
        'share_email' => 'Email',
        ...
        'shared_intro_gift' => 'This gift list is shared with several people. Mark what you are getting so nobody buys the same thing twice.',
    ...
    */
    'santa' => [
        ...
        'members' => 'Who is in',
        'draw' => 'Do the draw',
        'draw_confirm' => 'Do the draw for :count people? Everyone gets an email with a name, and that cannot be unsent.',
        'draw_needs_two' => 'The draw needs at least two people.',
    ...
    */
    'gift_cove' => [
        ...
        'seo_description' => 'Wish lists, lists for somebody else, buying together, Secret Santa, price alerts and gift ideas in one place. Nobody sees who bought what.',
        'title' => 'The Gift Cove',
        ...
        'ask_title' => 'Ask other people',
        'ask_body' => 'Describe who you are buying for and let the community suggest something. Every answer comes with real products and a price.',
        'alerts_title' => 'Notifications',
        'alerts_body' => 'Somebody shares a list with you, suggests something, a friend has a birthday coming, a price drops: you hear it here and by mail.',
        'friends_title' => 'Friends',
        'friends_body' => 'The people you share lists with, with their birthdays, so a reminder arrives two weeks before the day.',
        'daily_title' => 'The daily Cove',
        'daily_body' => 'A small hand-picked selection, new every morning. Good for when you are not looking for anything in particular.',
        'guides_title' => 'Buying guides',
        'guides_body' => 'What matters when you choose, by subject, with the products that fit. Read before you buy, not after.',
        'ideas_title' => 'Gift ideas',
        ...
        'wishlist_title' => 'Share your own wish list',
        'wishlist_body' => 'Save what you would like and share the link. Whoever opens it claims what they are getting, so nothing is bought twice. You never see any of that.',
        ...
        'giftlist_cta' => 'Start a list for somebody',
        'split_title' => 'Buy separately for one person',
        'split_body' => 'Share a list about somebody with the other givers. Whoever buys something claims it, so nobody buys the same thing twice.',
        'split_cta' => 'Start coordinating',
        'handover_cta' => 'Hand a list over',
        'build_title' => 'Build a list together',
        'build_body' => 'Turn on "anyone can add" and everybody with the link puts things on it. Adding only: nobody but you can take anything off.',
        'build_cta' => 'Open a list to share',
        'collab_cta' => 'Start a group gift',
        'board_title' => 'Talk about a list',
        'board_body' => 'Every shared list has a board beside it, for the givers only. The person the list is for never sees it.',
        'board_cta' => 'Open a shared list',
        'santa_cta' => 'Start a group',
        'quiz_cta' => 'Make a quiz',
        'friends_cta' => 'See my friends',
        'whisperer_cta' => 'Describe somebody',
        'search_cta' => 'Search',
        'ask_cta' => 'Ask',
        'alerts_cta' => 'See my notifications',
        'daily_cta' => 'See today',
        'guides_cta' => 'Read the guides',
        'ideas_cta' => 'Browse ideas',
        'surprise_cta' => 'Surprise me',
    ],
    ...
    'wizard' => [
        ...
        'step_sharing' => 'Sharing',
        'step_done' => 'Done',
        'kind_hint' => 'This decides what the list can do. Everything else can be changed later; this cannot.',
        'title_for' => 'For :name',
        'kind_mine_body' => 'Things you would like. Keep it to yourself, or share it: then people claim what they are getting, so nothing is bought twice. You never see what, or who.',
        'kind_for_someone_body' => 'A list about somebody else. Keep it to yourself as research, or share it: then you build it together and split the shopping, so nobody buys the same thing twice.',
        'kind_group_body' => 'Several people buying one present. Everybody votes, chips in, and one of you buys it.',
        ...
        'occasion_hint_mine' => 'A wish list with a date is a registry: people see what it is for and when. You can add a delivery address on the list afterwards, visible only to whoever claims something. We remind you two weeks before.',
        'occasion_hint_other' => 'Say what it is for and when, and we remind you two weeks before, five days before and on the day.',
        'date_label' => 'Date',
        'date_known' => 'That falls on :date.',
        'date_other' => 'A different date',
        'date_from_birthday' => 'We put that birthday on the list as the date.',
        'date_needs_birthday' => 'Fill in their birthday above and the date comes with it.',
        'date_needs_mine' => 'We do not know your birthday, so pick the date here. You can add your birthday on the Friends page.',
        'sharing' => 'Who can see it?',
        'sharing_hint_mine' => 'Private means only you. Sharing means anybody with the link can open it and claim what they are getting, so nothing is bought twice.',
        'sharing_hint_for_someone' => 'Private means only you: your own notes about them. Share it and the other givers can claim things, add ideas and talk on the board.',
        'sharing_hint_group' => 'A group gift needs the others on it: share it and send them the link. They vote, chip in, and talk on the board.',
        'visibility_private' => 'Private',
        'visibility_link' => 'Share with a link',
        'visibility_private_mine' => 'Only you see it. You can share it any time.',
        'visibility_link_mine' => 'Anybody with the link sees it and claims what they are getting, so nothing is bought twice. Nothing about that ever reaches you.',
        'visibility_private_for_someone' => 'Only you see it. Good for collecting ideas quietly.',
        'visibility_link_for_someone' => 'The other givers see it, claim what they take, and the person it is for never learns a thing.',
        'visibility_private_group' => 'Only you, for now. You can share it once it has something on it.',
        'visibility_link_group' => 'Everybody with the link votes, pledges and talks. The person it is for never sees it.',
        'can_add_hint' => 'Build the list together: anybody with the link can put things on it. Only you can take things off.',
        'friends_hint' => 'They get an email with the link, and the list appears on their Friends page.',
        'friends_none' => 'Once somebody opens a link of yours, they become a friend and you can share lists with them by name.',
        'rule' => 'One rule runs through all of it: whoever a list is for never learns what has been claimed. Not who, not how much, not that anything has.',
        'summary' => 'This is what you are making',
        'shared_with_count' => 'shared with :count',
        'after' => 'Next: put things on it. Anything you find on the site saves to it with one press, and you can paste a link to anything from anywhere else.',
        'back' => 'Back',
        'next' => 'Next',
        'sign_in_hint' => 'Sign in to keep this list. Your answers are kept while you do.',
        'sign_in_and_create' => 'Sign in and make the list',
    ],

    'reminders' => [
        'birthday_title' => ':name\'s birthday is coming up',
        'birthday_today_title' => 'Today is :name\'s birthday',
        'birthday_today' => 'Today is the day. If something is on the way, now is the moment to send a message too.',
    ...
    'notifications' => [
        ...
        'list_shared' => ':name shared “:list” with you',
        'list_suggestion' => 'A new suggestion for “:list”',
        'list_item_added' => 'Someone added something to “:list”',
        'list_message' => 'A new message on “:list”',
        'list_pledge' => 'Someone chipped in for “:list”',
        'list_claimed' => 'Something on “:list” has been spoken for',
        'list_claimed_item' => 'Spoken for on “:list”: “:item”',
        'title' => 'Notifications',
        'recent' => 'Recent',
    ...
    */
    ...
    /*
     * How lists work. Ordered the way somebody meets it — find, save, look —
     * rather than the way it is built, because nobody creates an empty list and
     * then goes shopping for it.
     */
    'lists_help' => [
     ...
     *
     * Made by following somebody's share link and having an account at the end
     * of it, or by adding an address here. See App\Services\Social\Friends.
     */
    'friends' => [
        'title' => 'Friends',
        ...
        'they_see' => 'Your lists, which :name can see',
        'day' => 'Day',
        'month' => 'Month',
        'their_birthday' => 'Their birthday',
        'their_birthday_optional' => 'Their birthday (optional)',
        'add_birthday' => 'Add a birthday',
        'edit_birthday' => 'Edit birthday',
        'remove' => 'Remove',
        'remove_confirm' => 'Remove :name? You will each disappear from the other\'s friends.',
        'removed' => 'Removed. You are no longer connected.',
        'save' => 'Save',
        'add_title' => 'Add someone',
        'add_hint' => 'By email. If they already have an account you are connected now; if not, they will be as soon as they sign in. We do not email them.',
        'email' => 'Their email',
        'add' => 'Add',
        ...
        'see_birthday' => 'Let friends see my birthday',
